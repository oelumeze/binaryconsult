...
class Images
{
     ...
     * @param $masterdim(optional) specifying what to use for master dimension, e.g auto, height, width
     * @param $enlarge (optional) Whether a smaller original should be enlarge
     * @return mixed False if no action was performed, else void
     */
    function resize ($originalFile, $newWidth = 120, $newHeight = 120, $newFile = '', $masterdim = 'auto', $enlarge = false)
    {
